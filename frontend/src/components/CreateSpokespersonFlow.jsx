...
// PR CW — delegate to the shared composer in `characterPromptBuilder`.
// The legacy approach hand-rolled per-template f-strings in this file
// AND in the backend, which drifted into redundancy ("polished
// commercial mascot portrait of an anthropomorphic mascot
// spokesperson — an anthropomorphic donkey…"). The shared composer
// produces clean, deterministic prompts (300–500 char target, 700
// hard cap) for both surfaces. `style` here packs chips + free-form
// wardrobe text together with a `;` separator; the composer parses
// that contract.
