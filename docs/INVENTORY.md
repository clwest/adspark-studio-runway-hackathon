...
context-kit refresh after PR CF (V2 Copy Cleanup + Remove
Dev Jargon) on top of the PR AG–CE / SESSION 011 anchors +
the SESSION 059 QA findings. Backend route count remains
**70** (PR CF is frontend-only copy polish). Lane scaffold
